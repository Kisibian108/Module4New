...
<div class="container">
    <form:form action="/save" modelAttribute="medicalDeclaration" method="post">
        ...
        <form:radiobutton path="vehicle" value="tàu bay"/> Tàu bay <form:radiobutton path="vehicle"
                                                                                     value="tàu thuyền"/> tàu thuyền
        <form:radiobutton path="vehicle" value="ô tô"/> Ô tô <form:radiobutton path="vehicle"
                                                                               value="khác"/> Khác (Ghi rõ) <br>
