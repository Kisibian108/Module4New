...
<div class="container">
    ...
    <form:form method="post" modelAttribute="medical" action="update?id=${medical.id}">
        <div class="mb-3">
        ...
        <div class="row">
            <div class="col">
                <div class="mb-3">
                    <form:label path="year" class="form-label">Năm Sinh</form:label>
                    <form:select path="year" class="form-control" items="${yearOfBirthList}"/>
                </div>
            </div>
            <div class="col">
                <div class="mb-3">
            ...
            <div class="col">
                <div class="mb-3">
                    ...
                    <form:select path="national" class="form-select" items="${nationalityList}"/>
                </div>
            </div>
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <div>
                <div class="form-check form-check-inline">
                    <form:radiobutton path="travel" class="form-check-input" label="Tàu bay" value="Tàu bay"/>
                </div>
                <div class="form-check form-check-inline">
                    <form:radiobutton path="travel" class="form-check-input" label="Tàu thuyền" value="Tàu thuyền"/>
                </div>
                <div class="form-check form-check-inline">
                    <form:radiobutton path="travel" class="form-check-input" label="ô tô" value="ô tô"/>
                </div>
                <div class="form-check form-check-inline">
                    <form:radiobutton path="travel" class="form-check-input" label="khác(ghi rõ)" value="khác"/>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col">
                <div class="mb-3">
                    ...
                    <form:input path="idTravel" cssClass="form-control"/>
                </div>
            </div>
            <div class="col">
                <div class="mb-3">
                    <label class="form-label">số ghế</label>
                    <form:input path="chair" cssClass="form-control"/>
                </div>
            </div>
        </div>
        <div class="row">
        ...
        <div class="mb-3">
            ...
            <form:input path="infomation" class="form-control"/>
        </div>
